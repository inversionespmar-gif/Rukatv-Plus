...
const { Button, Image } = require('rukautv/components');
const { useFullscreen } = require('rukautv/common/Fullscreen');
const { useHorizontalNavGamepadNavigation } = require('rukautv/services/GamepadNavigation');
                ...
                backButton ?
                    ...
                    <div className={styles['logo-container']}>
                        <Image
                            ...
                            src={require('/assets/images/rukautv_symbol.png')}
                            alt={' '}
                        />
                    </div>
            }
