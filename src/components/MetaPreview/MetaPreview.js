...
const { default: Button } = require('rukautv/components/Button');
const { default: Image } = require('rukautv/components/Image');
const { default: ActionsGroup } = require('rukautv/components/ActionsGroup');
const ModalDialog = require('rukautv/components/ModalDialog');
const SharePrompt = require('rukautv/components/SharePrompt');
const CONSTANTS = require('rukautv/common/CONSTANTS');
const routesRegexp = require('rukautv/common/routesRegexp');
const useBinaryState = require('rukautv/common/useBinaryState');
