...
import { Button } from 'rukautv/components';
import { useCore } from 'rukautv/core';
import useProfile from 'rukautv/common/useProfile';
import { withCoreSuspender } from 'rukautv/common/CoreSuspender';
    ...
    return (
        <div className={classnames(className, styles['warning-container'])}>
            ...
            <div className={styles['actions']}>
                <a
                    href='https://rukatv.com/download-service'
                    target='_blank'
                    rel='noreferrer'
                >
                    <Button
